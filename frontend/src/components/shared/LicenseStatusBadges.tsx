...
export function LicenseStatusBadges({ status, isBlocked = false, isNew = false }: LicenseStatusBadgesProps) {
  ...
  return (
    <div className="inline-flex flex-wrap items-center gap-2">
      ...
      {isNew ? (
        <span className="inline-flex items-center rounded-full border border-fuchsia-200 bg-fuchsia-100 px-2 py-0.5 text-sm font-semibold uppercase tracking-wide text-fuchsia-700 shadow-sm dark:border-fuchsia-900/60 dark:bg-fuchsia-950/50 dark:text-fuchsia-300">
