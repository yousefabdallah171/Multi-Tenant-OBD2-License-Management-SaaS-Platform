...
export function ActivityPage() {
  ...
  const activityQuery = useQuery({
    queryKey: ['manager-parent', 'activity', page, perPage, userId, action, range.from, range.to],
    queryFn: () => activityService.getAll({ page, per_page: perPage, user_id: userId, action, from: range.from, to: range.to }),
  })

  const teamQuery = useQuery({
    queryKey: ['manager-parent', 'activity', 'team-users'],
