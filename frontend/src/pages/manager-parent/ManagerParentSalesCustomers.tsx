...
export function ManagerParentSalesCustomersPage() {
  ...
  const salesQuery = useQuery({
    queryKey: ['manager-parent', 'reseller-payments', 'manager-parent-customers', resolvedManagerParentId, filters],
    queryFn: () => managerParentService.getManagerParentSalesCustomers(resolvedManagerParentId, filters),
