...
export function FinancialReportsPage() {
  ...
  const activationsDetailsUrl = buildQueryUrl(routePaths.managerParent.resellerLogs(lang), {
  ...
  return (
    <div className="space-y-6">
      <PageHeader
        ...
        actions={<ExportButtons onExportCsv={() => managerParentService.exportFinancialCsv(range)} onExportPdf={() => managerParentService.exportFinancialPdf(range)} />}
      />
