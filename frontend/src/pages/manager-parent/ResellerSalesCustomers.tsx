...
export function ResellerSalesCustomersPage() {
  ...
  const salesQuery = useQuery({
    queryKey: ['manager-parent', 'reseller-payments', 'reseller-customers', resolvedResellerId, filters],
    queryFn: () => managerParentService.getResellerSalesCustomers(resolvedResellerId, filters),
