  ...
  return (
    <div className="space-y-6">
      ...
      <div className="grid gap-3 md:grid-cols-3 xl:grid-cols-6">
        ...
        <StatusFilterCard label={t('roles.manager')} count={usersQuery.data?.role_counts.manager ?? 0} isActive={role === 'manager'} onClick={() => { setRole('manager'); setPage(1) }} color="violet" />
